...
\guido{mancano dettagli degli autori di Roberto e di Laura}
...
present the first results: CMM~\cite{Attardi1998}, a memory manager for C++, and TAUMUS~\cite{NenciniGBCT86}, a music compositor. \guido{Ho brevemente descritto i due software. Per TAUMUS non ho trovato meglio di \cite{NenciniGBCT86}} 
