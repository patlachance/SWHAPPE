...
\begin{enumerate}
	...
	\item (illustration) The authors/scavengers \carlo{scavengers ?} should have a standard way to save documents (pictures, etc.) of historical relevance related to the recovered SC. The illustrators should have easy access to it. This entails that there should be:
	\begin{enumerate}
...
A CVS, where anyone can develop, curate, integrate and then submit changes to the project's maintainers, is well suited for the multi-users acquisition process we describe.\carlo{State as requir. - utenti diversi e ruoli diversi}
...
\carlo{Questa strada ben si sposa ad utilizzare altri strumenti standard e open source come wikimedia \cite{wiki:Wikimedia_movement}, CodeMeta \cite{SoftwareCitation2016}}

\

\noindent
8 - [Experimental use: Run the process on a representative sample of SC developed in Pisa, in view of the 50th anniversary celebration, current candidates] \carlo{maestro del trionfo della morte}
...
\nocite{*}
\guido{sarebbe da citare Spinellis e GNU, ad ora assenti}
\printbibliography
